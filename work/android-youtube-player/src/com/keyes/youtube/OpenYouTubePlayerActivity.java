...
public class OpenYouTubePlayerActivity extends Activity {
    ...
    static final String YOUTUBE_VIDEO_INFORMATION_URL = "https://www.youtube.com/get_video_info?eurl=http%3A%2F%2Fi.admin.bytedance.com%2F&html5=1&video_id=";
    ...
    private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
        ...
        @Override
        protected void onPostExecute(final Uri pResult) {
...
//                if (showControllerOnStartup) lMediaController.show(0);
                ...
                mVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer pMp) {
                        ...
                        pMp.setVolume(0f, 0f);
//                        pMp.setAudioStreamType(AudioManager.STREAM_VOICE_CALL);
                        pMp.setLooping(true);
                    }
