...
lock = threading.Lock
headers = {'User-Agent': 'Instagram 35.0.0.20.96 Android (23/6.0.1; 416dpi; 1170x1872; HUAWEI; Mate 10 Pro; x86; cancro; zh_CN; 95414347)',
...
def login():
    d = {"phone_id":"e40cf722-2116-474e-b7dc-fccdc5e01c50","username":email,"adid":"2acaf82e-080f-404d-8268-50d487a7c5e2","guid":"758492fb-2663-4f27-a99c-beedcf904d33","device_id":"android-b209e9dbbbf0f081","password":password,"login_attempt_count":"0"}
    d = json.dumps(d)
